...
b1=Radiobutton(w1,text='Search',command=search)
b2=Radiobutton(w1,text='Add',command=add)
b3=Radiobutton(w1,text='Update',command=update)
b4=Radiobutton(w1,text='Delete',command=delete)
b5=Radiobutton(w1,text='Clear',command=clear)
